 ...
 */ var hc = Au,
  ...
  Sc = hc.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function Ji(e, n, t) {
  ...
  for (r in n) wc.call(n, r) && !kc.hasOwnProperty(r) && (l[r] = n[r]);
  if (e && e.defaultProps)
...
function Ic(e, n, t, r, l, u, o, i, s) {
  (kt = !1), (Tr = null), Mc.apply(Dc, arguments);
}
function Fc(e, n, t, r, l, u, o, i, s) {
  if ((Ic.apply(this, arguments), kt)) {
    if (kt) {
      var c = Tr;
      (kt = !1), (Tr = null);
...
function Ju(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Ko(e, r), n & 4 && -1 < Gc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Gt(l);
        if (
          (u !== null && Ps(u),
...
var lt = {
  ...
  nl = A({}, Xt, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== dt &&
            (dt && e.type === 'mousemove'
              ? ((Cl = e.screenX - dt.screenX), (xl = e.screenY - dt.screenY))
              : (xl = Cl = 0),
            (dt = e)),
          Cl);
    },
  ...
  tf = ge(nf),
  rf = A({}, Xt, { relatedTarget: 0 }),
  Pl = ge(rf),
  lf = A({}, lt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  uf = ge(lf),
  of = A({}, lt, {
...
var mf = A({}, Xt, {
  ...
  gf = ge(yf),
  wf = A({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Sf = ge(wf),
  kf = A({}, nl, {
    deltaX: function (e) {
...
var Cf = He && 'TextEvent' in window && !Et,
...
function ti() {
  _t && (_t.detachEvent('onpropertychange', Us), (It = _t = null));
}
function Us(e) {
  if (e.propertyName === 'value' && tl(It)) {
    var n = [];
    Fs(n, It, e, Yu(e)), ys(zf, n);
  }
}
function Tf(e, n, t) {
  e === 'focusin'
    ? (ti(), (_t = n), (It = t), _t.attachEvent('onpropertychange', Us))
    : e === 'focusout' && ti();
}
function Rf(e) {
...
var Ff = He && 'documentMode' in document && 11 >= document.documentMode,
  In = null,
  au = null,
  Ct = null,
  cu = !1;
...
var wt =
  ...
  $f = new Set('cancel close invalid load scroll toggle'.split(' ').concat(wt));
function ii(e, n, t) {
  ...
  if (!e[sr]) {
    (e[sr] = !0),
      ns.forEach(function (t) {
        t !== 'selectionchange' && ($f.has(t) || Ol(t, !1, e), Ol(t, !0, e));
      });
...
var mu = typeof setTimeout == 'function' ? setTimeout : void 0,
  ...
  Hf =
    typeof queueMicrotask == 'function'
      ...
      : typeof ci < 'u'
        ? function (e) {
            return ci.resolve(null).then(e).catch(Wf);
          }
        : mu;
function Wf(e) {
  setTimeout(function () {
...
var Yr = {
  ...
  bf = {
    ...
    useTransition: function () {
      var e = wi(!1),
        n = e[0];
      return (e = Zf.bind(null, e[1])), (De().memoizedState = e), [n, e];
    },
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    Cr(e, n), Ca(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[vu], delete n[Qf], delete n[Kf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Qo(t), n === 1))
      e.tag === 0 ? Yf(ji.bind(null, e)) : Zs(ji.bind(null, e)),
        Hf(function () {
          !(R & 6) && mn();
        }),
        (t = null);
...
function gn(e, n, t) {
  var r = O,
    l = Ee.transition;
  try {
    (Ee.transition = null), (O = 1), vd(e, n, t, r);
  } finally {
    (Ee.transition = l), (O = r);
  }
  return null;
...
Ya = function (e, n, t) {
  if (e !== null)
    if (e.memoizedProps !== n.pendingProps || ce.current) ae = !0;
      ...
      if (!(e.lanes & t) && !(n.flags & 128)) return (ae = !1), ud(e, n, t);
      ae = !!(e.flags & 131072);
    }
...
vs = Co;
hs = zn;
var xd = { usingClientEntryPoint: !1, Events: [Gt, jn, ll, ps, ms, Co] },
  vt = {
...
function Ld() {
  return zr.jsx('div', {
    children: zr.jsx('h1', { children: '-Markus Einan-' }),
  });
}
